...
from polars import DataFrame as PolarDataFrame, Schema as PolarSchema, concat
from pyarrow import Schema as ArrowSchema, Table as ArrowTable, schema as create_schema
...
from baikal.common.parquet.time_series_partition import ParquetTSPartition


class ParquetTSWriter:
    def __init__(
        self,
        root: Path,
        partition: ParquetTSPartition,
        *,
        ...
        self._polar_expressions = partition.polar_expressions("date_time")
        ...
        self._schema: ArrowSchema | None = None

    @TimeSeries.polar().input("chunk")
    def write(self, chunk: PolarDataFrame) -> None:
        """Writes ordered `TimeSeries` polars chunks to parquet hive dataset.

        Parameters
        ----------
        chunk: PolarDataFrame
    ...
    def _drop_partitions(self, schema: ArrowSchema) -> ArrowSchema:
    ...
    @staticmethod
    def _validate_schema(expected: ArrowSchema, actual: ArrowSchema) -> None:
